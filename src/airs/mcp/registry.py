...
_TOOL_MANIFEST: list[dict] = [
    ...
    {
        "tool_name": "csv_analyze_metric_health",
        "mcp_server_id": "csv_engine",
        "tier": ToolTier.OBSERVATION,
        "signal_type": SignalType.CSV,
        "idempotent": True,
        "expected_latency_seconds": 3,
        "evidence_categories": ["metrics_current_state", "metrics_anomaly", "error_rate"],
        "description": "Smart hybrid tool to check if a specific metric is healthy or anomalous. Use this instead of raw SQL.",
    },
    {
        "tool_name": "csv_extract_log_errors",
        "mcp_server_id": "csv_engine",
        "tier": ToolTier.OBSERVATION,
        "signal_type": SignalType.CSV,
        "idempotent": True,
        "expected_latency_seconds": 5,
        "evidence_categories": ["error_logs", "application_logs", "error_frequency"],
        "description": "Smart hybrid tool to extract top 3 critical ERROR logs for a service. Use this instead of querying raw logs.",
    },
    {
